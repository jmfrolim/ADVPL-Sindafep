...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Tx Adm SOS'															, .T. }, ; //X3_TITULO
	{ 'Tx Adm SOS'															, .T. }, ; //X3_TITSPA
	{ 'Tx Adm SOS'															, .T. }, ; //X3_TITENG
	{ 'Taxa Administrativa SOS'												, .T. }, ; //X3_DESCRIC
	{ 'Taxa Administrativa SOS'												, .T. }, ; //X3_DESCSPA
	{ 'Taxa Administrativa SOS'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZF'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'ZF_TXAERO'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Tx Adm Aero'															, .T. }, ; //X3_TITULO
	{ 'Tx Adm Aero'															, .T. }, ; //X3_TITSPA
	{ 'Tx Adm Aero'															, .T. }, ; //X3_TITENG
	{ 'Taxa Administrativa Aero'											, .T. }, ; //X3_DESCRIC
	{ 'Taxa Administrativa Aero'											, .T. }, ; //X3_DESCSPA
	{ 'Taxa Administrativa Aero'											, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
