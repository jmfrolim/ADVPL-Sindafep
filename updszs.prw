...
/*/
//--------------------------------------------------------------------
User Function UPDSZS( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDSZS" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDSZS" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'HISTORICO FATURAMENTO CUSTOMIZ'										, ; //X2_NOME
	'HISTORICO FATURAMENTO CUSTOMIZ'										, ; //X2_NOMESPA
	'HISTORICO FATURAMENTO CUSTOMIZ'										, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'HISTORICO FILIACAO FISCAIS'											, ; //X2_NOME
	'HISTORICO FILIACAO FISCAIS'											, ; //X2_NOMESPA
	'HISTORICO FILIACAO FISCAIS'											, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'ADICIONAIS PLANOS'														, ; //X2_NOME
	'ADICIONAIS PLANOS'														, ; //X2_NOMESPA
	'ADICIONAIS PLANOS'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	{ 'SZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '54'																	, .T. }, ; //X3_ORDEM
	{ 'Z1_REGALTE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Reg Alterado'														, .T. }, ; //X3_TITULO
	{ 'Reg Alterado'														, .T. }, ; //X3_TITSPA
	{ 'Reg Alterado'														, .T. }, ; //X3_TITENG
	{ 'Registro Alterado'													, .T. }, ; //X3_DESCRIC
	{ 'Registro Alterado'													, .T. }, ; //X3_DESCSPA
	{ 'Registro Alterado'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '55'																	, .T. }, ; //X3_ORDEM
	{ 'Z1_VLANTER'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vl Anterior'															, .T. }, ; //X3_TITULO
	{ 'Vl Anterior'															, .T. }, ; //X3_TITSPA
	{ 'Vl Anterior'															, .T. }, ; //X3_TITENG
	{ 'Valor Anterior'														, .T. }, ; //X3_DESCRIC
	{ 'Valor Anterior'														, .T. }, ; //X3_DESCSPA
	{ 'Valor Anterior'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Usuario Alterou'														, .T. }, ; //X3_DESCRIC
	{ 'Usuario Alterou'														, .T. }, ; //X3_DESCSPA
	{ 'Usuario Alterou'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ1'																	, .T. }, ; //X3_ARQUIVO
	{ '58'																	, .T. }, ; //X3_ORDEM
	{ 'Z1_ALTHORA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hora Alt'															, .T. }, ; //X3_TITULO
	{ 'Hora Alt'															, .T. }, ; //X3_TITSPA
	{ 'Hora Alt'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'GETSXENUM("SZ2","Z2_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'SZ2'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'Z2_PREPASS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Perc. Repass'														, .T. }, ; //X3_TITULO
	{ 'Perc. Repass'														, .T. }, ; //X3_TITSPA
	{ 'Perc. Repass'														, .T. }, ; //X3_TITENG
	{ 'Percentual de Repasse'												, .T. }, ; //X3_DESCRIC
	{ 'Percentual de Repasse'												, .T. }, ; //X3_DESCSPA
	{ 'Percentual de Repasse'												, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Perc. SEAD'															, .T. }, ; //X3_TITULO
	{ 'Perc. SEAD'															, .T. }, ; //X3_TITSPA
	{ 'Perc. SEAD'															, .T. }, ; //X3_TITENG
	{ 'Percentual SEAD'														, .T. }, ; //X3_DESCRIC
	{ 'Percentual SEAD'														, .T. }, ; //X3_DESCSPA
	{ 'Percentual SEAD'														, .T. }, ; //X3_DESCENG
	{ '@E 999.9999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZ2'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'Z2_GREPASS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Gera Repasse'														, .T. }, ; //X3_TITULO
	{ 'Gera Repasse'														, .T. }, ; //X3_TITSPA
	{ 'Gera Repasse'														, .T. }, ; //X3_TITENG
	{ 'Gera Repasse'														, .T. }, ; //X3_DESCRIC
	{ 'Gera Repasse'														, .T. }, ; //X3_DESCSPA
	{ 'Gera Repasse'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'GETSXENUM("SZF","ZF_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	{ 'SZF'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'ZF_DESFUNC'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Desc Func'															, .T. }, ; //X3_TITULO
	{ 'Desc Func'															, .T. }, ; //X3_TITSPA
	{ 'Desc Func'															, .T. }, ; //X3_TITENG
	{ 'Desconto Funcionario'												, .T. }, ; //X3_DESCRIC
	{ 'Desconto Funcionario'												, .T. }, ; //X3_DESCSPA
	{ 'Desconto Funcionario'												, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Decl IRPF'															, .T. }, ; //X3_TITULO
	{ 'Decl IRPF'															, .T. }, ; //X3_TITSPA
	{ 'Decl IRPF'															, .T. }, ; //X3_TITENG
	{ 'Declara IRPF'														, .T. }, ; //X3_DESCRIC
	{ 'Declara IRPF'														, .T. }, ; //X3_DESCSPA
	{ 'Declara IRPF'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Codigo Titular'														, .T. }, ; //X3_DESCRIC
	{ 'Codigo Titular'														, .T. }, ; //X3_DESCSPA
	{ 'Codigo Titular'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Sist Ant'														, .T. }, ; //X3_TITULO
	{ 'Cod Sist Ant'														, .T. }, ; //X3_TITSPA
	{ 'Cod Sist Ant'														, .T. }, ; //X3_TITENG
	{ 'Codigo Sistema Anterior'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo Sistema Anterior'												, .T. }, ; //X3_DESCSPA
	{ 'Codigo Sistema Anterior'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZG'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZG_CDTTANT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd Tit Sis A'														, .T. }, ; //X3_TITULO
	{ 'Cd Tit Sis A'														, .T. }, ; //X3_TITSPA
	{ 'Cd Tit Sis A'														, .T. }, ; //X3_TITENG
	{ 'Cod Titular Sistema Anter'											, .T. }, ; //X3_DESCRIC
	{ 'Cod Titular Sistema Anter'											, .T. }, ; //X3_DESCSPA
	{ 'Cod Titular Sistema Anter'											, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Tit'															, .T. }, ; //X3_TITULO
	{ 'Nome Tit'															, .T. }, ; //X3_TITSPA
	{ 'Nome Tit'															, .T. }, ; //X3_TITENG
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_CODADIC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Adiciona'														, .T. }, ; //X3_TITULO
	{ 'Cod Adiciona'														, .T. }, ; //X3_TITSPA
	{ 'Cod Adiciona'														, .T. }, ; //X3_TITENG
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_DESADIC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descr Adicio'														, .T. }, ; //X3_TITULO
	{ 'Descr Adicio'														, .T. }, ; //X3_TITSPA
	{ 'Descr Adicio'														, .T. }, ; //X3_TITENG
	{ 'Descricao Adicional'													, .T. }, ; //X3_DESCRIC
	{ 'Descricao Adicional'													, .T. }, ; //X3_DESCSPA
	{ 'Descricao Adicional'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF(!INCLUI,POSICIONE(' + DUPLAS  + 'SZN' + DUPLAS  + ',3,XFILIAL(' + DUPLAS  + 'SZN' + DUPLAS  + ')+SZJ->ZJ_CODADIC,' + DUPLAS  + 'ZN_DESCR' + DUPLAS  + '),' + SIMPLES + '' + SIMPLES + ')', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SZN",3,XFILIAL("SZN")+SZJ->ZJ_CODADIC,"ZN_DESCR")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	{ 'SZJ'																	, .T. }, ; //X3_ARQUIVO
	{ '23'																	, .T. }, ; //X3_ORDEM
	{ 'ZJ_24HCOB'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cobr. 24H'															, .T. }, ; //X3_TITULO
	{ 'Cobr. 24H'															, .T. }, ; //X3_TITSPA
	{ 'Cobr. 24H'															, .T. }, ; //X3_TITENG
	{ 'Cobrado Incl. 24H'													, .T. }, ; //X3_DESCRIC
	{ 'Cobrado Incl. 24H'													, .T. }, ; //X3_DESCSPA
	{ 'Cobrado Incl. 24H'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TPDADO'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Dado'															, .T. }, ; //X3_TITULO
	{ 'Tipo Dado'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Dado'															, .T. }, ; //X3_TITENG
	{ 'Tipo Dado'															, .T. }, ; //X3_DESCRIC
	{ 'Tipo Dado'															, .T. }, ; //X3_DESCSPA
	{ 'Tipo Dado'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '05'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITPREF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Prefixo Tit'															, .T. }, ; //X3_TITULO
	{ 'Prefixo Tit'															, .T. }, ; //X3_TITSPA
	{ 'Prefixo Tit'															, .T. }, ; //X3_TITENG
	{ 'Prefixo do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Prefixo do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Prefixo do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITLOJA'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja Titulo'															, .T. }, ; //X3_TITULO
	{ 'Loja Titulo'															, .T. }, ; //X3_TITSPA
	{ 'Loja Titulo'															, .T. }, ; //X3_TITENG
	{ 'Loja Titulo'															, .T. }, ; //X3_DESCRIC
	{ 'Loja Titulo'															, .T. }, ; //X3_DESCSPA
	{ 'Loja Titulo'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITPARC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Parc Titulo'															, .T. }, ; //X3_TITULO
	{ 'Parc Titulo'															, .T. }, ; //X3_TITSPA
	{ 'Parc Titulo'															, .T. }, ; //X3_TITENG
	{ 'Parcela do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Parcela do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Parcela do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITFIL'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Filial Tit'															, .T. }, ; //X3_TITULO
	{ 'Filial Tit'															, .T. }, ; //X3_TITSPA
	{ 'Filial Tit'															, .T. }, ; //X3_TITENG
	{ 'Filial do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Filial do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Filial do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITNAT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Natureza Tit'														, .T. }, ; //X3_TITULO
	{ 'Natureza Tit'														, .T. }, ; //X3_TITSPA
	{ 'Natureza Tit'														, .T. }, ; //X3_TITENG
	{ 'Natureza do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Natureza do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Natureza do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '12'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITEMIS'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Emissao Tit'															, .T. }, ; //X3_TITULO
	{ 'Emissao Tit'															, .T. }, ; //X3_TITSPA
	{ 'Emissao Tit'															, .T. }, ; //X3_TITENG
	{ 'Emissao do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Emissao do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Emissao do Titulo'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '13'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITVNC'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Vencto Tit'															, .T. }, ; //X3_TITULO
	{ 'Vencto Tit'															, .T. }, ; //X3_TITSPA
	{ 'Vencto Tit'															, .T. }, ; //X3_TITENG
	{ 'Vencimento do Titulo'												, .T. }, ; //X3_DESCRIC
	{ 'Vencimento do Titulo'												, .T. }, ; //X3_DESCSPA
	{ 'Vencimento do Titulo'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '14'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITVNCR'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Venc Real Ti'														, .T. }, ; //X3_TITULO
	{ 'Venc Real Ti'														, .T. }, ; //X3_TITSPA
	{ 'Venc Real Ti'														, .T. }, ; //X3_TITENG
	{ 'Vencimento Real Titulo'												, .T. }, ; //X3_DESCRIC
	{ 'Vencimento Real Titulo'												, .T. }, ; //X3_DESCSPA
	{ 'Vencimento Real Titulo'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '16'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITCLI'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cliente Tit'															, .T. }, ; //X3_TITULO
	{ 'Cliente Tit'															, .T. }, ; //X3_TITSPA
	{ 'Cliente Tit'															, .T. }, ; //X3_TITENG
	{ 'Cliente Titulo'														, .T. }, ; //X3_DESCRIC
	{ 'Cliente Titulo'														, .T. }, ; //X3_DESCSPA
	{ 'Cliente Titulo'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '17'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_TITHIST'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 25																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hist Titulo'															, .T. }, ; //X3_TITULO
	{ 'Hist Titulo'															, .T. }, ; //X3_TITSPA
	{ 'Hist Titulo'															, .T. }, ; //X3_TITENG
	{ 'Historico do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Historico do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Historico do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINTTP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Integr'															, .T. }, ; //X3_TITULO
	{ 'Tipo Integr'															, .T. }, ; //X3_TITSPA
	{ 'Tipo Integr'															, .T. }, ; //X3_TITENG
	{ 'Tipo do Integrante Plano'											, .T. }, ; //X3_DESCRIC
	{ 'Tipo do Integrante Plano'											, .T. }, ; //X3_DESCSPA
	{ 'Tipo do Integrante Plano'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '19'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINTOR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Origem Integ'														, .T. }, ; //X3_TITULO
	{ 'Origem Integ'														, .T. }, ; //X3_TITSPA
	{ 'Origem Integ'														, .T. }, ; //X3_TITENG
	{ 'Origem do Integrante'												, .T. }, ; //X3_DESCRIC
	{ 'Origem do Integrante'												, .T. }, ; //X3_DESCSPA
	{ 'Origem do Integrante'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Cod Integran'														, .T. }, ; //X3_TITSPA
	{ 'Cod Integran'														, .T. }, ; //X3_TITENG
	{ 'Codigo do Integrante'												, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Integrante'												, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Integrante'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '21'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINTLJ'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Lj do Integr'														, .T. }, ; //X3_TITULO
	{ 'Lj do Integr'														, .T. }, ; //X3_TITSPA
	{ 'Lj do Integr'														, .T. }, ; //X3_TITENG
	{ 'Loja do Integrante'													, .T. }, ; //X3_DESCRIC
	{ 'Loja do Integrante'													, .T. }, ; //X3_DESCSPA
	{ 'Loja do Integrante'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '22'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINTNM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Integra'														, .T. }, ; //X3_TITULO
	{ 'Nome Integra'														, .T. }, ; //X3_TITSPA
	{ 'Nome Integra'														, .T. }, ; //X3_TITENG
	{ 'Nome do Integrante'													, .T. }, ; //X3_DESCRIC
	{ 'Nome do Integrante'													, .T. }, ; //X3_DESCSPA
	{ 'Nome do Integrante'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '23'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINTID'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Idade Integr'														, .T. }, ; //X3_TITULO
	{ 'Idade Integr'														, .T. }, ; //X3_TITSPA
	{ 'Idade Integr'														, .T. }, ; //X3_TITENG
	{ 'Idade do Integrante'													, .T. }, ; //X3_DESCRIC
	{ 'Idade do Integrante'													, .T. }, ; //X3_DESCSPA
	{ 'Idade do Integrante'													, .T. }, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	{ 'Cod Grupo Pl'														, .T. }, ; //X3_TITSPA
	{ 'Cod Grupo Pl'														, .T. }, ; //X3_TITENG
	{ 'Codigo Grupo Plano'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Grupo Plano'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Grupo Plano'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '25'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLGRPDS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Desc Grp Pl'															, .T. }, ; //X3_TITULO
	{ 'Desc Grp Pl'															, .T. }, ; //X3_TITSPA
	{ 'Desc Grp Pl'															, .T. }, ; //X3_TITENG
	{ 'Descricao Grupo Plano'												, .T. }, ; //X3_DESCRIC
	{ 'Descricao Grupo Plano'												, .T. }, ; //X3_DESCSPA
	{ 'Descricao Grupo Plano'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '27'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLDESCR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descr Plano'															, .T. }, ; //X3_TITULO
	{ 'Descr Plano'															, .T. }, ; //X3_TITSPA
	{ 'Descr Plano'															, .T. }, ; //X3_TITENG
	{ 'Descricao do Plano'													, .T. }, ; //X3_DESCRIC
	{ 'Descricao do Plano'													, .T. }, ; //X3_DESCSPA
	{ 'Descricao do Plano'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 'Cod Faixa'															, .T. }, ; //X3_TITSPA
	{ 'Cod Faixa'															, .T. }, ; //X3_TITENG
	{ 'Codigo Faixa Idade'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Faixa Idade'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Faixa Idade'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Descr Faixa'															, .T. }, ; //X3_TITSPA
	{ 'Descr Faixa'															, .T. }, ; //X3_TITENG
	{ 'Descr Faixa Etaria'													, .T. }, ; //X3_DESCRIC
	{ 'Descr Faixa Etaria'													, .T. }, ; //X3_DESCSPA
	{ 'Descr Faixa Etaria'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Val Plano'															, .T. }, ; //X3_TITULO
	{ 'Val Plano'															, .T. }, ; //X3_TITSPA
	{ 'Val Plano'															, .T. }, ; //X3_TITENG
	{ 'Valor do Plano'														, .T. }, ; //X3_DESCRIC
	{ 'Valor do Plano'														, .T. }, ; //X3_DESCSPA
	{ 'Valor do Plano'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '31'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLVLCOB'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Val Cobr Pl'															, .T. }, ; //X3_TITULO
	{ 'Val Cobr Pl'															, .T. }, ; //X3_TITSPA
	{ 'Val Cobr Pl'															, .T. }, ; //X3_TITENG
	{ 'Valor Cobrado Plano'													, .T. }, ; //X3_DESCRIC
	{ 'Valor Cobrado Plano'													, .T. }, ; //X3_DESCSPA
	{ 'Valor Cobrado Plano'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '32'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLVLFUN'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Valor Fundo'															, .T. }, ; //X3_TITULO
	{ 'Valor Fundo'															, .T. }, ; //X3_TITSPA
	{ 'Valor Fundo'															, .T. }, ; //X3_TITENG
	{ 'Valor do Fundo'														, .T. }, ; //X3_DESCRIC
	{ 'Valor do Fundo'														, .T. }, ; //X3_DESCSPA
	{ 'Valor do Fundo'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '33'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLVLTXA'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Valor Tx Adm'														, .T. }, ; //X3_TITULO
	{ 'Valor Tx Adm'														, .T. }, ; //X3_TITSPA
	{ 'Valor Tx Adm'														, .T. }, ; //X3_TITENG
	{ 'Valor Taxa Administrativa'											, .T. }, ; //X3_DESCRIC
	{ 'Valor Taxa Administrativa'											, .T. }, ; //X3_DESCSPA
	{ 'Valor Taxa Administrativa'											, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '36'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLIDLIM'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 3																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Idade Limite'														, .T. }, ; //X3_TITULO
	{ 'Idade Limite'														, .T. }, ; //X3_TITSPA
	{ 'Idade Limite'														, .T. }, ; //X3_TITENG
	{ 'Idade Limite da Faixa'												, .T. }, ; //X3_DESCRIC
	{ 'Idade Limite da Faixa'												, .T. }, ; //X3_DESCSPA
	{ 'Idade Limite da Faixa'												, .T. }, ; //X3_DESCENG
	{ '@E 999'																, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'Cobertura Pl'														, .T. }, ; //X3_TITULO
	{ 'Cobertura Pl'														, .T. }, ; //X3_TITSPA
	{ 'Cobertura Pl'														, .T. }, ; //X3_TITENG
	{ 'Cobertura do Plano'													, .T. }, ; //X3_DESCRIC
	{ 'Cobertura do Plano'													, .T. }, ; //X3_DESCSPA
	{ 'Cobertura do Plano'													, .T. }, ; //X3_DESCENG
	{ '@E 999.9999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '38'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLINC24'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Inclusao 24h'														, .T. }, ; //X3_TITULO
	{ 'Inclusao 24h'														, .T. }, ; //X3_TITSPA
	{ 'Inclusao 24h'														, .T. }, ; //X3_TITENG
	{ 'Inclusao 24h'														, .T. }, ; //X3_DESCRIC
	{ 'Inclusao 24h'														, .T. }, ; //X3_DESCSPA
	{ 'Inclusao 24h'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '39'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLCOB24'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cobrou 24h'															, .T. }, ; //X3_TITULO
	{ 'Cobrou 24h'															, .T. }, ; //X3_TITSPA
	{ 'Cobrou 24h'															, .T. }, ; //X3_TITENG
	{ 'Cobrou 24h'															, .T. }, ; //X3_DESCRIC
	{ 'Cobrou 24h'															, .T. }, ; //X3_DESCSPA
	{ 'Cobrou 24h'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '40'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLDIA24'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Dias Cobr 24'														, .T. }, ; //X3_TITULO
	{ 'Dias Cobr 24'														, .T. }, ; //X3_TITSPA
	{ 'Dias Cobr 24'														, .T. }, ; //X3_TITENG
	{ 'Dias Cobrados 24H'													, .T. }, ; //X3_DESCRIC
	{ 'Dias Cobrados 24H'													, .T. }, ; //X3_DESCSPA
	{ 'Dias Cobrados 24H'													, .T. }, ; //X3_DESCENG
	{ '@E 9,999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '41'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_PLVL24'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Vl Cobr 24h'															, .T. }, ; //X3_TITULO
	{ 'Vl Cobr 24h'															, .T. }, ; //X3_TITSPA
	{ 'Vl Cobr 24h'															, .T. }, ; //X3_TITENG
	{ 'Valor Cobrado 24H'													, .T. }, ; //X3_DESCRIC
	{ 'Valor Cobrado 24H'													, .T. }, ; //X3_DESCSPA
	{ 'Valor Cobrado 24H'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '42'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_ADGRPCD'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cd Grp Adic'															, .T. }, ; //X3_TITULO
	{ 'Cd Grp Adic'															, .T. }, ; //X3_TITSPA
	{ 'Cd Grp Adic'															, .T. }, ; //X3_TITENG
	{ 'Codigo do Grupo do Adicio'											, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Grupo do Adicio'											, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Grupo do Adicio'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '43'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_ADGRPDS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 20																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Ad Grp Descr'														, .T. }, ; //X3_TITULO
	{ 'Ad Grp Descr'														, .T. }, ; //X3_TITSPA
	{ 'Ad Grp Descr'														, .T. }, ; //X3_TITENG
	{ 'Adicional Grupo Descr'												, .T. }, ; //X3_DESCRIC
	{ 'Adicional Grupo Descr'												, .T. }, ; //X3_DESCSPA
	{ 'Adicional Grupo Descr'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod Adicion'															, .T. }, ; //X3_TITULO
	{ 'Cod Adicion'															, .T. }, ; //X3_TITSPA
	{ 'Cod Adicion'															, .T. }, ; //X3_TITENG
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Adicional'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '45'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_ADDESCR'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Adic Descr'															, .T. }, ; //X3_TITULO
	{ 'Adic Descr'															, .T. }, ; //X3_TITSPA
	{ 'Adic Descr'															, .T. }, ; //X3_TITENG
	{ 'Descricao do Adicional'												, .T. }, ; //X3_DESCRIC
	{ 'Descricao do Adicional'												, .T. }, ; //X3_DESCSPA
	{ 'Descricao do Adicional'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Decl IRPF'															, .T. }, ; //X3_TITSPA
	{ 'Decl IRPF'															, .T. }, ; //X3_TITENG
	{ 'Declaracao IRPF'														, .T. }, ; //X3_DESCRIC
	{ 'Declaracao IRPF'														, .T. }, ; //X3_DESCSPA
	{ 'Declaracao IRPF'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '47'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPRECNO'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 11																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'CoPart Rec'															, .T. }, ; //X3_TITULO
	{ 'CoPart Rec'															, .T. }, ; //X3_TITSPA
	{ 'CoPart Rec'															, .T. }, ; //X3_TITENG
	{ 'Recno Reg CoParticipacao'											, .T. }, ; //X3_DESCRIC
	{ 'Recno Reg CoParticipacao'											, .T. }, ; //X3_DESCSPA
	{ 'Recno Reg CoParticipacao'											, .T. }, ; //X3_DESCENG
	{ '@E 99999999999'														, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '49'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPBENNM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 25																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Benefic'														, .T. }, ; //X3_TITULO
	{ 'Nome Benefic'														, .T. }, ; //X3_TITSPA
	{ 'Nome Benefic'														, .T. }, ; //X3_TITENG
	{ 'Nome do Beneficiario'												, .T. }, ; //X3_DESCRIC
	{ 'Nome do Beneficiario'												, .T. }, ; //X3_DESCSPA
	{ 'Nome do Beneficiario'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '50'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPATDDT'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Atendim'														, .T. }, ; //X3_TITULO
	{ 'Data Atendim'														, .T. }, ; //X3_TITSPA
	{ 'Data Atendim'														, .T. }, ; //X3_TITENG
	{ 'Data Atendimento'													, .T. }, ; //X3_DESCRIC
	{ 'Data Atendimento'													, .T. }, ; //X3_DESCSPA
	{ 'Data Atendimento'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '51'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPATDTP'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Tipo Atendim'														, .T. }, ; //X3_TITULO
	{ 'Tipo Atendim'														, .T. }, ; //X3_TITSPA
	{ 'Tipo Atendim'														, .T. }, ; //X3_TITENG
	{ 'Tipo de Atendimento'													, .T. }, ; //X3_DESCRIC
	{ 'Tipo de Atendimento'													, .T. }, ; //X3_DESCSPA
	{ 'Tipo de Atendimento'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '52'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPATDDS'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 80																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descr Atend'															, .T. }, ; //X3_TITULO
	{ 'Descr Atend'															, .T. }, ; //X3_TITSPA
	{ 'Descr Atend'															, .T. }, ; //X3_TITENG
	{ 'Descricao do Atendimento'											, .T. }, ; //X3_DESCRIC
	{ 'Descricao do Atendimento'											, .T. }, ; //X3_DESCSPA
	{ 'Descricao do Atendimento'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '53'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPPRNOM'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nome Prestad'														, .T. }, ; //X3_TITULO
	{ 'Nome Prestad'														, .T. }, ; //X3_TITSPA
	{ 'Nome Prestad'														, .T. }, ; //X3_TITENG
	{ 'Nome do Prestador'													, .T. }, ; //X3_DESCRIC
	{ 'Nome do Prestador'													, .T. }, ; //X3_DESCSPA
	{ 'Nome do Prestador'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '54'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPVLSER'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Val Servico'															, .T. }, ; //X3_TITULO
	{ 'Val Servico'															, .T. }, ; //X3_TITSPA
	{ 'Val Servico'															, .T. }, ; //X3_TITENG
	{ 'Valor do Servico'													, .T. }, ; //X3_DESCRIC
	{ 'Valor do Servico'													, .T. }, ; //X3_DESCSPA
	{ 'Valor do Servico'													, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '55'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPCOBDV'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 1																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cob ou Dev'															, .T. }, ; //X3_TITULO
	{ 'Cob ou Dev'															, .T. }, ; //X3_TITSPA
	{ 'Cob ou Dev'															, .T. }, ; //X3_TITENG
	{ 'Cobranca ou Devolucao'												, .T. }, ; //X3_DESCRIC
	{ 'Cobranca ou Devolucao'												, .T. }, ; //X3_DESCSPA
	{ 'Cobranca ou Devolucao'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZL'																	, .T. }, ; //X3_ARQUIVO
	{ '56'																	, .T. }, ; //X3_ORDEM
	{ 'ZL_CPPINSS'															, .T. }, ; //X3_CAMPO
	{ 'N'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 4																		, .T. }, ; //X3_DECIMAL
	{ 'INSS CoPart'															, .T. }, ; //X3_TITULO
	{ 'INSS CoPart'															, .T. }, ; //X3_TITSPA
	{ 'INSS CoPart'															, .T. }, ; //X3_TITENG
	{ 'Perc NSS CoParticipacao'												, .T. }, ; //X3_DESCRIC
	{ 'Perc NSS CoParticipacao'												, .T. }, ; //X3_DESCSPA
	{ 'Perc NSS CoParticipacao'												, .T. }, ; //X3_DESCENG
	{ '@E 999.9999'															, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '02'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_FILFISC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Fil Fiscal'															, .T. }, ; //X3_TITULO
	{ 'Fil Fiscal'															, .T. }, ; //X3_TITSPA
	{ 'Fil Fiscal'															, .T. }, ; //X3_TITENG
	{ 'Filial do Fiscal'													, .T. }, ; //X3_DESCRIC
	{ 'Filial do Fiscal'													, .T. }, ; //X3_DESCSPA
	{ 'Filial do Fiscal'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '03'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_LOJFISC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Loja Fiscal'															, .T. }, ; //X3_TITULO
	{ 'Loja Fiscal'															, .T. }, ; //X3_TITSPA
	{ 'Loja Fiscal'															, .T. }, ; //X3_TITENG
	{ 'Loja Fiscal'															, .T. }, ; //X3_DESCRIC
	{ 'Loja Fiscal'															, .T. }, ; //X3_DESCSPA
	{ 'Loja Fiscal'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Codigo do Fiscal'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Fiscal'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Fiscal'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Acao'															, .T. }, ; //X3_TITULO
	{ 'Data Acao'															, .T. }, ; //X3_TITSPA
	{ 'Data Acao'															, .T. }, ; //X3_TITENG
	{ 'Data Acao'															, .T. }, ; //X3_DESCRIC
	{ 'Data Acao'															, .T. }, ; //X3_DESCSPA
	{ 'Data Acao'															, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_DTMANUT'															, .T. }, ; //X3_CAMPO
	{ 'D'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Manut'															, .T. }, ; //X3_TITULO
	{ 'Data Manut'															, .T. }, ; //X3_TITSPA
	{ 'Data Manut'															, .T. }, ; //X3_TITENG
	{ 'Data Manutencao'														, .T. }, ; //X3_DESCRIC
	{ 'Data Manutencao'														, .T. }, ; //X3_DESCSPA
	{ 'Data Manutencao'														, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_HRMANUT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Hora Manut'															, .T. }, ; //X3_TITULO
	{ 'Hora Manut'															, .T. }, ; //X3_TITSPA
	{ 'Hora Manut'															, .T. }, ; //X3_TITENG
	{ 'Hora da Manutencao'													, .T. }, ; //X3_DESCRIC
	{ 'Hora da Manutencao'													, .T. }, ; //X3_DESCSPA
	{ 'Hora da Manutencao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_USMANUT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Usuario Manu'														, .T. }, ; //X3_TITULO
	{ 'Usuario Manu'														, .T. }, ; //X3_TITSPA
	{ 'Usuario Manu'														, .T. }, ; //X3_TITENG
	{ 'Usuario Manutencao'													, .T. }, ; //X3_DESCRIC
	{ 'Usuario Manutencao'													, .T. }, ; //X3_DESCSPA
	{ 'Usuario Manutencao'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZM'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZM_NMMANUT'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nm Usr Manut'														, .T. }, ; //X3_TITULO
	{ 'Nm Usr Manut'														, .T. }, ; //X3_TITSPA
	{ 'Nm Usr Manut'														, .T. }, ; //X3_TITENG
	{ 'Nome Usuario Manutencao'												, .T. }, ; //X3_DESCRIC
	{ 'Nome Usuario Manutencao'												, .T. }, ; //X3_DESCSPA
	{ 'Nome Usuario Manutencao'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'GETSXENUM("SZN","ZN_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	{ 'Cod Grupo'															, .T. }, ; //X3_TITSPA
	{ 'Cod Grupo'															, .T. }, ; //X3_TITENG
	{ 'Codigo Grupo Planos'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo Grupo Planos'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo Grupo Planos'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Descr Grupo'															, .T. }, ; //X3_TITSPA
	{ 'Descr Grupo'															, .T. }, ; //X3_TITENG
	{ 'Descricao Grupo'														, .T. }, ; //X3_DESCRIC
	{ 'Descricao Grupo'														, .T. }, ; //X3_DESCSPA
	{ 'Descricao Grupo'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, .T. }, ; //X3_USADO
	{ 'IF(!INCLUI,POSICIONE(' + DUPLAS  + 'SZD' + DUPLAS  + ',1,XFILIAL(' + DUPLAS  + 'SZN' + DUPLAS  + ')+SZN->ZN_CODGRP,' + DUPLAS  + 'ZD_DESCR' + DUPLAS  + '),' + SIMPLES + '' + SIMPLES + ')', .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
	{ Chr(254) + Chr(192)													, .T. }, ; //X3_RESERV
	{ ''																	, .T. }, ; //X3_CHECK
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'POSICIONE("SZD",1,XFILIAL("SZN")+SZN->ZN_CODGRP,"ZD_DESCR")'			, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 14																	, .T. }, ; //X3_TAMANHO
	{ 2																		, .T. }, ; //X3_DECIMAL
	{ 'Taxa Admin'															, .T. }, ; //X3_TITULO
	{ 'Taxa Admin'															, .T. }, ; //X3_TITSPA
	{ 'Taxa Admin'															, .T. }, ; //X3_TITENG
	{ 'Taxa Admin'															, .T. }, ; //X3_DESCRIC
	{ 'Taxa Admin'															, .T. }, ; //X3_DESCSPA
	{ 'Taxa Admin'															, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Nr do Recibo'														, .T. }, ; //X3_DESCRIC
	{ 'Nr do Recibo'														, .T. }, ; //X3_DESCSPA
	{ 'Nr do Recibo'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 2																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Serie Recibo'														, .T. }, ; //X3_TITULO
	{ 'Serie Recibo'														, .T. }, ; //X3_TITSPA
	{ 'Serie Recibo'														, .T. }, ; //X3_TITENG
	{ 'Serie Recibo'														, .T. }, ; //X3_DESCRIC
	{ 'Serie Recibo'														, .T. }, ; //X3_DESCSPA
	{ 'Serie Recibo'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Forma de Pagamento'													, .T. }, ; //X3_DESCRIC
	{ 'Forma de Pagamento'													, .T. }, ; //X3_DESCSPA
	{ 'Forma de Pagamento'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 4																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr Banco'															, .T. }, ; //X3_TITULO
	{ 'Nr Banco'															, .T. }, ; //X3_TITSPA
	{ 'Nr Banco'															, .T. }, ; //X3_TITENG
	{ 'Numero Banco'														, .T. }, ; //X3_DESCRIC
	{ 'Numero Banco'														, .T. }, ; //X3_DESCSPA
	{ 'Numero Banco'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '06'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_CHEQUE'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 10																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Nr Cheque'															, .T. }, ; //X3_TITULO
	{ 'Nr Cheque'															, .T. }, ; //X3_TITSPA
	{ 'Nr Cheque'															, .T. }, ; //X3_TITENG
	{ 'Numero do Cheque'													, .T. }, ; //X3_DESCRIC
	{ 'Numero do Cheque'													, .T. }, ; //X3_DESCSPA
	{ 'Numero do Cheque'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '07'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_DESCR1'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descricao 1'															, .T. }, ; //X3_TITULO
	{ 'Descricao 1'															, .T. }, ; //X3_TITSPA
	{ 'Descricao 1'															, .T. }, ; //X3_TITENG
	{ 'Descricao 1'															, .T. }, ; //X3_DESCRIC
	{ 'Descricao 1'															, .T. }, ; //X3_DESCSPA
	{ 'Descricao 1'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '08'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_DESCR2'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descricao 2'															, .T. }, ; //X3_TITULO
	{ 'Descricao 2'															, .T. }, ; //X3_TITSPA
	{ 'Descricao 2'															, .T. }, ; //X3_TITENG
	{ 'Descricao 2'															, .T. }, ; //X3_DESCRIC
	{ 'Descricao 2'															, .T. }, ; //X3_DESCSPA
	{ 'Descricao 2'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '09'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_DESCR3'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descricao 3'															, .T. }, ; //X3_TITULO
	{ 'Descricao 3'															, .T. }, ; //X3_TITSPA
	{ 'Descricao 3'															, .T. }, ; //X3_TITENG
	{ 'Descricao 3'															, .T. }, ; //X3_DESCRIC
	{ 'Descricao 3'															, .T. }, ; //X3_DESCSPA
	{ 'Descricao 3'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '10'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_DESCR4'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descricao 4'															, .T. }, ; //X3_TITULO
	{ 'Descricao 4'															, .T. }, ; //X3_TITSPA
	{ 'Descricao 4'															, .T. }, ; //X3_TITENG
	{ 'Descricao 4'															, .T. }, ; //X3_DESCRIC
	{ 'Descricao 4'															, .T. }, ; //X3_DESCSPA
	{ 'Descricao 4'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '11'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_DESCR5'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descricao 5'															, .T. }, ; //X3_TITULO
	{ 'Descricao 5'															, .T. }, ; //X3_TITSPA
	{ 'Descricao 5'															, .T. }, ; //X3_TITENG
	{ 'Descricao 5'															, .T. }, ; //X3_DESCRIC
	{ 'Descricao 5'															, .T. }, ; //X3_DESCSPA
	{ 'Descricao 5'															, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Emissor'																, .T. }, ; //X3_TITSPA
	{ 'Emissor'																, .T. }, ; //X3_TITENG
	{ 'Emissor'																, .T. }, ; //X3_DESCRIC
	{ 'Emissor'																, .T. }, ; //X3_DESCSPA
	{ 'Emissor'																, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '18'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_TITDESC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Descr Titulo'														, .T. }, ; //X3_TITULO
	{ 'Descr Titulo'														, .T. }, ; //X3_TITSPA
	{ 'Descr Titulo'														, .T. }, ; //X3_TITENG
	{ 'Descricao do Titulo'													, .T. }, ; //X3_DESCRIC
	{ 'Descricao do Titulo'													, .T. }, ; //X3_DESCSPA
	{ 'Descricao do Titulo'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Data de Venc. do Titulo'												, .T. }, ; //X3_DESCRIC
	{ 'Data de Venc. do Titulo'												, .T. }, ; //X3_DESCSPA
	{ 'Data de Venc. do Titulo'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Valor Titulo'														, .T. }, ; //X3_TITSPA
	{ 'Valor Titulo'														, .T. }, ; //X3_TITENG
	{ 'Valor Titulo'														, .T. }, ; //X3_DESCRIC
	{ 'Valor Titulo'														, .T. }, ; //X3_DESCSPA
	{ 'Valor Titulo'														, .T. }, ; //X3_DESCENG
	{ '@E 99,999,999,999.99'												, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '24'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_CLIEND'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 50																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'End Cliente'															, .T. }, ; //X3_TITULO
	{ 'End Cliente'															, .T. }, ; //X3_TITSPA
	{ 'End Cliente'															, .T. }, ; //X3_TITENG
	{ 'Endereco Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Endereco Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Endereco Cliente'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	{ 'SZR'																	, .T. }, ; //X3_ARQUIVO
	{ '25'																	, .T. }, ; //X3_ORDEM
	{ 'ZR_CLICIUF'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 40																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cid UF Clien'														, .T. }, ; //X3_TITULO
	{ 'Cid UF Clien'														, .T. }, ; //X3_TITSPA
	{ 'Cid UF Clien'														, .T. }, ; //X3_TITENG
	{ 'Cidade/UF Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Cidade/UF Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Cidade/UF Cliente'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Telefones Cliente'													, .T. }, ; //X3_DESCRIC
	{ 'Telefones Cliente'													, .T. }, ; //X3_DESCSPA
	{ 'Telefones Cliente'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ1'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'Z1_FILIAL+Z1_CDBENEF'													, ; //CHAVE
	'Cod Benefic'															, ; //DESCRICAO
	'Cod Benefic'															, ; //DESCSPA
	'Cod Benefic'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZG'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZG_FILIAL+ZG_CODTIT+ZG_NOME'											, ; //CHAVE
	'Cod Titular+Nome'														, ; //DESCRICAO
	'Cod Titular+Nome'														, ; //DESCSPA
	'Cod Titular+Nome'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZG'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'ZG_FILIAL+ZG_CDANT'													, ; //CHAVE
	'Cod Sist Ant'															, ; //DESCRICAO
	'Cod Sist Ant'															, ; //DESCSPA
	'Cod Sist Ant'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZH'																	, ; //INDICE
	'5'																		, ; //ORDEM
	'ZH_FILIAL+ZH_CODTIT'													, ; //CHAVE
	'Cod Titular'															, ; //DESCRICAO
	'Cod Titular'															, ; //DESCSPA
	'Cod Titular'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
...
aAdd( aSIX, { ;
	'SZH'																	, ; //INDICE
	'6'																		, ; //ORDEM
	'ZH_FILIAL+ZH_CODGRP+ZH_CODTIT'											, ; //CHAVE
	'Cod Grupo+Cod Titular'													, ; //DESCRICAO
	'Cod Grupo+Cod Titular'													, ; //DESCSPA
	'Cod Grupo+Cod Titular'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	...
	'Cod Integran'															, ; //DESCRICAO
	'Cod Integran'															, ; //DESCSPA
	'Cod Integran'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZJ'																	, ; //INDICE
	'3'																		, ; //ORDEM
	'ZJ_FILIAL+ZJ_FAMILIA+ZJ_CODPAR+ZJ_CODIGO'								, ; //CHAVE
	'Familia+Cod Parentes+Cod Integran'										, ; //DESCRICAO
	'Familia+Cod Parentes+Cod Integran'										, ; //DESCSPA
	'Familia+Cod Parentes+Cod Integran'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZJ'																	, ; //INDICE
	'4'																		, ; //ORDEM
	'ZJ_FILIAL+ZJ_CODIGO+ZJ_LOJA'											, ; //CHAVE
	'Cod Integran+Loja'														, ; //DESCRICAO
	'Cod Integran+Loja'														, ; //DESCSPA
	'Cod Integran+Loja'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZL'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZL_FILIAL+ZL_COMPET+ZL_FAMILIA+ZL_TITPREF+ZL_TITNUM'					, ; //CHAVE
	'Competencia+Familia+Prefixo Tit+Num Titulo'							, ; //DESCRICAO
	'Competencia+Familia+Prefixo Tit+Num Titulo'							, ; //DESCSPA
	'Competencia+Familia+Prefixo Tit+Num Titulo'							, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	...
	'2'																		, ; //ORDEM
	'ZL_PLINTNM'															, ; //CHAVE
	'Nome Integra'															, ; //DESCRICAO
	'Nome Integra'															, ; //DESCSPA
	'Nome Integra'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZM'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZM_FILIAL+ZM_FILFISC+ZM_LOJFISC+ZM_CODFISC+ZM_DATA'					, ; //CHAVE
	'Fil Fiscal+Loja Fiscal+Cod Fiscal+Data Acao'							, ; //DESCRICAO
	'Fil Fiscal+Loja Fiscal+Cod Fiscal+Data Acao'							, ; //DESCSPA
	'Fil Fiscal+Loja Fiscal+Cod Fiscal+Data Acao'							, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZM'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZM_FILIAL+ZM_DTMANUT+ZM_HRMANUT'										, ; //CHAVE
	'Data Manut+Hora Manut'													, ; //DESCRICAO
	'Data Manut+Hora Manut'													, ; //DESCSPA
	'Data Manut+Hora Manut'													, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZN'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZN_FILIAL+ZN_CODGRP+ZN_CODIGO'											, ; //CHAVE
	'Cod Grupo+Codigo'														, ; //DESCRICAO
	'Cod Grupo+Codigo'														, ; //DESCSPA
	'Cod Grupo+Codigo'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZR'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZR_FILIAL+ZR_SERIE+ZR_NUM'												, ; //CHAVE
	'Serie Recibo+Nr Recibo'												, ; //DESCRICAO
	'Serie Recibo+Nr Recibo'												, ; //DESCSPA
	'Serie Recibo+Nr Recibo'												, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZR'																	, ; //INDICE
	'2'																		, ; //ORDEM
	'ZR_FILIAL+ZR_TITPREF+ZR_TITNUM+ZR_TITPARC'								, ; //CHAVE
	'Prefixo Tit+Nr Titulo+Parc Titulo'										, ; //DESCRICAO
	'Prefixo Tit+Nr Titulo+Parc Titulo'										, ; //DESCSPA
	'Prefixo Tit+Nr Titulo+Parc Titulo'										, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	...
	'SA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'XFILIAL("SA1")+ZH_CODTIT'												, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	"ZJ_CODPAR== '000000'"													} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	...
	'SA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'XFILIAL("SA1")+ZH_CODTIT+ZH_LOJA'										, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	"ZJ_CODPAR=='000000'"													} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	...
	''																		, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	"ALLTRIM(M->ZJ_CODPLAN) != ''"											} ) //X7_CONDIC
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'RE'																	, ; //XB_COLUNA
	'TITULAR PLANOS'														, ; //XB_DESCRI
	'TITULAR PLANOS'														, ; //XB_DESCSPA
	'TITULAR PLANOS'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZL'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'FAMILIAS DE PLANOS'													, ; //XB_DESCRI
	'FAMILIAS DE PLANOS'													, ; //XB_DESCSPA
	'FAMILIAS DE PLANOS'													, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZH'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'TITULARES PLANOS'														, ; //XB_DESCRI
	'TITULARES PLANOS'														, ; //XB_DESCSPA
	'TITULARES PLANOS'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZL'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Nome Integra'															, ; //XB_DESCRI
	'Nome Integra'															, ; //XB_DESCSPA
	'Nome Integra'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Lj do Integr'															, ; //XB_DESCRI
	'Lj do Integr'															, ; //XB_DESCSPA
	'Lj do Integr'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZL_PLINTLJ'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'Cod Integran'															, ; //XB_DESCRI
	'Cod Integran'															, ; //XB_DESCSPA
	'Cod Integran'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZL_PLINTCD'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'04'																	, ; //XB_COLUNA
	'Origem Integ'															, ; //XB_DESCRI
	'Origem Integ'															, ; //XB_DESCSPA
	'Origem Integ'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZL_PLINTOR'															} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	"SZL->ZL_PLINTNM + ' | ' + SZL->ZL_PLINTOR + ' | ' +SZL->ZL_PLINTCD + ' | ' +SZL->ZL_PLINTLJ"} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'ADICIONAIS PLANOS'														, ; //XB_DESCRI
	'ADICIONAIS PLANOS'														, ; //XB_DESCSPA
	'ADICIONAIS PLANOS'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZN'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'01'																	, ; //XB_COLUNA
	'Cod Grupo+codigo'														, ; //XB_DESCRI
	'Cod Grupo+codigo'														, ; //XB_DESCSPA
	'Cod Grupo+codigo'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	''																		, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZN->ZN_CODGRP == M->ZH_CODGRP'										} ) //XB_CONTEM
...
aHlpPor := {}
aAdd( aHlpPor, 'Percentual de Repasse' )

PutHelp( "PZ2_PREPASS", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z2_PREPASS" )

aHlpPor := {}
aAdd( aHlpPor, 'Percentual SEAD' )

PutHelp( "PZ2_PSEAD  ", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z2_PSEAD" )

aHlpPor := {}
aAdd( aHlpPor, 'Gera Repasse' )

PutHelp( "PZ2_GREPASS", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z2_GREPASS" )
